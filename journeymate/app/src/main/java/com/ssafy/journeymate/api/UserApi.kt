...
data class RegistUserData(val id: String, val nickname : String, val imgUrl : String, val createdAt : LocalDateTime, val updatedAt : LocalDateTime)

data class FindUserResponse(val message : String, val data : FindUserData)

data class FindUserData(val id : String, val nickname : String, val imgUrl : String, val createdAt: LocalDateTime , val updatedAt: LocalDateTime)

data class ModifyUserProfileResponse(val message : String, val data : ModifyUserProfileData)

data class ModifyUserProfileData(val id : String, val nickname : String, val imgUrl : String, val updatedAt: LocalDateTime)

data class RegistMateBridgeResponse(val message: String, val data : RegistMateBridgeData)

data class RegistMateBridgeData(val id:Long, val user : FindUserData, val mateId : Long, val createdAt: LocalDateTime, val updatedAt: LocalDateTime, val isCreator:Boolean)
...
data class ModifyMateBridgeData(val id:Long, val user : FindUserData, val mateId : Long, val createdAt: LocalDateTime, val updatedAt: LocalDateTime, val isCreator:Boolean)
...
data class FindDocsData(val title : String , val docsId : Long, val createdData : LocalDateTime, val imgFileInfo : List<FileRessponseDto>)
...
data class FindJourneyData(val id : Long, val mateId : Long, val categoryId : Long, val title : String , val day : Integer, val sequence : Integer, val xcoordinate : Float, val ycoordinate : Float)

data class FindMateResponse(val message : String, val data : FindMateData)

data class FindMateData(val mateId : Long, val name : String, val startDate : LocalDateTime, val endData : LocalDateTime, val users : List<String>, val destination : String , val creator : String, val createdDate : LocalDateTime)
