...
data class MateGroupData(val name : String, val destination : String, val startDate : LocalDateTime, val endDate : LocalDateTime, val users : MutableList<String>, val creator : String, val createdDate : LocalDateTime, val mateId : Long )
...
data class ContentData(val creatorId : String, val contentId : Long, val createdDate: LocalDateTime, val imgUrl: HttpUrl, val fileName : String, val type : Boolean)
...
data class DocsListData(val title: String, val docsId : Long, val userId: String, val createdDate: LocalDateTime, val imgFileInfo : List<ImageFileInfo>)
...
data class DocsDetailData(val nickname: String, val title: String, val content : String, val docsId: Long, val createdDate: LocalDateTime, val imgFileInfo: List<ImageFileInfo> )
...
data class ModifyDocsData(val nickname: String, val title: String, val content: String, val docsId: Long, val createdDate: LocalDateTime, val updatedDate: LocalDateTime, val imgFileInfo: List<ImageFileInfo>)
...
interface MateApi{
    ...
    fun registContent(@Body registContentsRequest: RegistContentsRequest, @Part imgFile : List<MultipartBody.Part>) : Call<RegistContentInfoResponse>
    ...
    fun modifyDocs(@Body modifyDocsRequest: ModifyDocsRequest, @Part imgFile : List<MultipartBody.Part>) : Call<ModifyDocsResponse>
...
data class RegistMateRequest(val destination: String, val name : String, val startDate : LocalDateTime, val endDate : LocalDateTime, val users : MutableList<String>, val creator : String )

data class ModifyMateRequest(val mateId : Long, val name : String, val destination : String, val users : MutableList<String>, val creator : String)
...
data class RegistDocsRequest(val title: String, val content: String, val mateId : Long, val userId : String)

data class ModifyDocsRequest(val title: String, val content: String, val userId: String, val docsId: Long)
